...
class WorkOrdersControllerTest < ActionController::TestCase
  ...
  test "should create work_order" do
    assert_difference('WorkOrder.count') do
      post :create, work_order: { product_configuration_id: @work_order.product_configuration_id, purchase_order_id: @work_order.purchase_order_id, status: @work_order.status, worker_id: @work_order.worker_id }
    end
  ...
  test "should update work_order" do
    patch :update, id: @work_order, work_order: { product_configuration_id: @work_order.product_configuration_id, purchase_order_id: @work_order.purchase_order_id, status: @work_order.status, worker_id: @work_order.worker_id }
    assert_redirected_to work_order_path(assigns(:work_order))
  end
